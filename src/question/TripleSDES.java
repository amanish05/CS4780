...
public class TripleSDES {
	...
	public static void main(String[] args) {
		...
		String pt, firstKey, secondKey, info = null;

		try {
			do {

				System.out.println("Press key 1 => Encrypt, 2 => Decrypt, 0 => Terminate\n");
				info = sc.next();
				...
				if (info.equals("1")) {
					...
					byte[] encryptedText = Encrypt(DES.convertToByte(firstKey), DES.convertToByte(secondKey),
							DES.convertToByte(pt));
					System.out.print("\nCiphertext is: ");
					...
					byte[] decryptedText = Decrypt(DES.convertToByte(firstKey), DES.convertToByte(secondKey),
							DES.convertToByte(pt));
					System.out.print("\nPlaintext is: ");
