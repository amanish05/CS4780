		...
		try {
			do {
				...
				if (info.equals("1")) {
					...
					byte[] encryptedText = Encrypt(convertToByte(givenKey), convertToByte(pt));
					System.out.print("\nCiphertext is: ");
					...
					byte[] decryptedText = Decrypt(convertToByte(givenKey), convertToByte(pt));
					System.out.print("\nPlaintext is: ");
